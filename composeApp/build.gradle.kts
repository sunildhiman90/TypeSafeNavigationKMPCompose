...
android {
    namespace = "com.sunildhiman90.typesafenavkmpcompose"
    ...
    defaultConfig {
        applicationId = "com.sunildhiman90.typesafenavkmpcompose"
...
compose.desktop {
    application {
        mainClass = "com.sunildhiman90.typesafenavkmpcompose.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.sunildhiman90.typesafenavkmpcompose"
